...
`deploy-netcup.yml` veröffentlicht Mission Space auf dem Netcup-Webserver unter
...
`MISSION_SPACE_DEPLOY_PATH` muss auf den Unterordner `mission-space` innerhalb des Dokumentenstamms von `moodle.harzenetter.eu` zeigen und auf `/mission-space` enden.
